    ...
    >
      {problems.map((item, i) => {
        ...
        return (
          ...
          >
            {/* Glow wrapper — sits outside overflow-hidden inner card */}
            <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={2} />

            <div className="relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-black/20 transition-all duration-300 flex flex-col">
              {/* ── Problem header (dark) ─────────────────── */}
              <div
              ...
              <div className="bg-white p-6 pt-7 border-t-0 border border-gray-100">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#0d9488' }} />
                  <div>
                    <p className="text-xs font-semibold text-teal-600 uppercase tracking-wider mb-1">Our Fix</p>
