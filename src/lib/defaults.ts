...
export const defaultTrustedByMarquee: TrustedByMarqueeData = {
  ...
  direction: 'left',
  logos: [
    { clientName: 'Sparkle Light',            logoFilename: 'sparkle-light.png',            order: 1,  scale: 1.25 },
    { clientName: 'Bethel International',     logoFilename: 'bethel-international.jpg',     order: 2,  scale: 1.2  },
    { clientName: 'Joseph Kitchen and Bath',  logoFilename: 'joseph-kitchen-and-bath.png',  order: 3,  scale: 1.0  },
    { clientName: 'Dentistry on Guelph',      logoFilename: 'dentistry-on-guelph.png',      order: 4,  scale: 1.15 },
    { clientName: 'First Electrical Supply',  logoFilename: 'first-electrical-supply.png',  order: 5,  scale: 1.0  },
    { clientName: 'Smiles on Sparks',         logoFilename: 'smiles-on-sparks.png',         order: 6,  scale: 1.3  },
    { clientName: 'Smile Express',            logoFilename: 'smile-express.png',            order: 7,  scale: 1.0  },
    { clientName: 'AM Group Studio',          logoFilename: 'am-group-studio.jpg',          order: 8,  scale: 1.0  },
    { clientName: 'Direct Air Systems',       logoFilename: 'direct-air-systems.png',       order: 9,  scale: 1.0  },
    { clientName: 'Maison Opes',              logoFilename: 'maison-opes.png',              order: 10, scale: 1.0  },
    { clientName: 'Nootk',                    logoFilename: 'nootk.svg',                    order: 11, scale: 1.2  },
    { clientName: 'Venizzi Kitchen and Bath', logoFilename: 'venizzi-kitchen-and-bath.jpg', order: 12, scale: 1.0  },
  ],
};
