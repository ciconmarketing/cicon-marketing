...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      initialValue: [
        { _key: 'cl01', clientName: 'Sparkle Light',            logoFilename: 'sparkle-light.png',            order: 1  },
        { _key: 'cl02', clientName: 'Bethel International',     logoFilename: 'bethel-international.jpg',     order: 2  },
        { _key: 'cl03', clientName: 'Joseph Kitchen and Bath',  logoFilename: 'joseph-kitchen-and-bath.png',  order: 3  },
        { _key: 'cl04', clientName: 'Dentistry on Guelph',      logoFilename: 'dentistry-on-guelph.png',      order: 4  },
        { _key: 'cl05', clientName: 'First Electrical Supply',  logoFilename: 'first-electrical-supply.png',  order: 5  },
        { _key: 'cl06', clientName: 'Smiles on Sparks',         logoFilename: 'smiles-on-sparks.png',         order: 6  },
        { _key: 'cl07', clientName: 'Smile Express',            logoFilename: 'smile-express.png',            order: 7  },
        { _key: 'cl08', clientName: 'AM Group Studio',          logoFilename: 'am-group-studio.jpg',          order: 8  },
        { _key: 'cl09', clientName: 'Direct Air Systems',       logoFilename: 'direct-air-systems.png',       order: 9  },
        { _key: 'cl10', clientName: 'Maison Opes',              logoFilename: 'maison-opes.png',              order: 10 },
        { _key: 'cl11', clientName: 'Nootk',                    logoFilename: 'nootk.svg',                    order: 11 },
        { _key: 'cl12', clientName: 'Venizzi Kitchen and Bath', logoFilename: 'venizzi-kitchen-and-bath.jpg', order: 12 },
      ],
    }),
    defineField({
      name: 'marqueeSpeed',
