    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'subheadline', title: 'Subheadline', type: 'text', rows: 2,
          initialValue: "Operating across the Greater Toronto Area since 2023 — founded by a Google-certified strategist with a Master's in Engineering and 14+ years building data-driven growth systems." }),
        defineField({ name: 'foundingYear', title: 'Founding Year (e.g. "2023")', type: 'string',
          description: 'Used in "Operating since {year}" copy. Defaults to 2023 if left empty.',
          initialValue: '2023' }),
      ],
    }),
    defineField({
